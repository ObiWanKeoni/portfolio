# run with:
# rails new my_app -m ./keoni_portfolio/template.rb
# rails new my_app -m https://raw.githubusercontent.com/atomicjolt/keoni_portfolio/master/template.rb

require "fileutils"
require "securerandom"

# repo = "git@github.com:atomicjolt/keoni_portfolio.git"
repo = "https://github.com/atomicjolt/keoni_portfolio.git"
...
modify_files.each do |f|
  gsub_file(f, "keoni_portfolio") do |_match|
    app_name.underscore
  end

  gsub_file(f, "KeoniPortfolio") do |_match|
  ...
  gsub_file(f, "Keoni Portfolio") do |_match|
    app_name.titleize
  end
end
